...
class TestGlobalRecommendation(unittest.TestCase):
    ...
    def test_main(self, mock_get_item, mock_get_all_orders, mock_get_cafe_items):
        # Test1 Empty cafe
        ...
        mock_get_all_orders.return_value = [
            {'order_id': 'order1', 'items': [{'slug': 'item1'}, {'slug': 'item2'}]}, 
            {'order_id': 'order2', 'items': [{'slug': 'item3'}, {'slug': 'item4'}]}, 
            {'order_id': 'order3', 'items': [{'slug': 'item5'}, {'slug': 'item6'}]}
        ]
