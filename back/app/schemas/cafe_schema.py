...
class CafeCreate(BaseModel):
    ...
    description: str = Field(
        ..., min_length=1, max_length=255, description="Description of the cafe."
    )
    logo_url: Optional[str] = Field(
        None, max_length=755, description="Logo URL of the cafe."
    )
    image_url: Optional[str] = Field(
        None, max_length=755, description="Image URL of the cafe."
    )
    ...
    status_message: Optional[str] = Field(
        None, max_length=50, description="Status message about the cafe."
    )
    ...
    social_media: SocialMedia = Field(
        ..., description="Social media profiles of the cafe."
    )
    payment_methods: List[PaymentMethod] = Field(
        ..., description="Accepted payment methods at the cafe."
    )
    additional_info: List[AdditionalInfo] = Field(
        ..., description="Additional information about the cafe."
    )
    staff: List[StaffMember] = Field(..., description="Staff members of the cafe.")
    menu_item_ids: List[PydanticObjectId] = Field(
        ..., description="List of menu item IDs offered by the cafe."
    )


class CafeUpdate(BaseModel):
    name: Optional[str] = Field(
        None, min_length=1, max_length=50, description="Updated name of the cafe."
    )
    features: Optional[List[Feature]] = Field(
        None, description="Updated features of the cafe."
    )
    ...
    is_open: Optional[bool] = Field(
        None, description="Updated open status of the cafe."
    )
    status_message: Optional[str] = Field(
        None, max_length=50, description="Updated status message of the cafe."
    )
    opening_hours: Optional[List[DayHours]] = Field(
        None, description="Updated opening hours of the cafe."
    )
    location: Optional[Location] = Field(
        None, description="Updated location details of the cafe."
    )
    contact: Optional[Contact] = Field(
        None, description="Updated contact information of the cafe."
    )
    social_media: Optional[SocialMedia] = Field(
        None, description="Updated social media profiles of the cafe."
    )
    payment_methods: Optional[List[PaymentMethod]] = Field(
        None, description="Updated payment methods accepted at the cafe."
    )
    additional_info: Optional[List[AdditionalInfo]] = Field(
        None, description="Updated additional information about the cafe."
    )
...
class CafeOut(BaseModel):
    ...
    status_message: Optional[str] = Field(
        None, description="Status message about the cafe."
    )
    opening_hours: List[DayHours] = Field(..., description="Opening hours of the cafe.")
    location: Location = Field(..., description="Location details of the cafe.")
    contact: Contact = Field(..., description="Contact information of the cafe.")
    ...
    payment_methods: List[PaymentMethod] = Field(
        ..., description="Payment methods accepted at the cafe."
    )
    additional_info: List[AdditionalInfo] = Field(
        ..., description="Additional information about the cafe."
    )
    staff: List[StaffMember] = Field(..., description="Staff members of the cafe.")
    menu_items: List[MenuItemEmbedded] = Field(
        ..., description="List of menu items offered by the cafe."
    )
