...
### 3.1 Collaborative Filtering (recommandation individuelle)
...
### 3.2 Content Based Filtering (recommandation individuelle)
...
### 3.3 Knowledge Based Recommender (recommandation individuelle)

1. Récupérer les repas allergènes par **2.3** et garder les repas de niveau II et III
...
### 3.4 Recommandation globale (ensemble des utilisateurs)

1. Récupérer les k repas possédant le plus de likes dans le menu et les recommander

### 3.5 Recommandation de café basé sur la recherche de repas
...
## 4. Robot de recommandation de repas santé

### 4.1 Définition du score de santé
...
### 4.2 Conception du robot

1. Définir n ensemble(s) qui représentent les repas qui devraient être consommés à n moment de la journée (un ensemble pour les repas qui devraient être consommés entre 8h-10h AM etc.)
    1. Déterminer un critère sur lequel il faudrait se baser pour rajouter les aliments dans un cluster
2. Mettre chaque aliment dans le bon cluster en se basant sur le critère trouvé en 1.1
3. Dans chaque ensemble, attribuer un score santé à chaque élément de l’ensemble
4. En fonction du moment de la journée, trouver le bon ensemble de repas et retourner les k repas avec le plus haut score


# Références

- [Lien Medium](https://towardsdatascience.com/introduction-to-recommender-systems-1-971bd274f421): Description des systèmes de recommandation.
- [Geeks for Geeks](https://www.geeksforgeeks.org/recommendation-system-in-python/): Implémentation d'un système en python.
- [Market Basket Analysis description](https://www.youtube.com/watch?v=icGS26TS1fE&ab_channel=DATAtab), [MBA python](https://medium.com/@jihargifari/how-to-perform-market-basket-analysis-in-python-bd00b745b106): Intéressant pour voir la relation entre les repas (quel repas est souvent consommé avec quel repas etc.) pour l’utilisateur.
- [Base de donnée de test](https://www.kaggle.com/datasets/joebeachcapital/fast-food)
- [Fatsecret](https://platform.fatsecret.com/)
- [Python Machine Learning - K-means (w3schools.com)](https://www.w3schools.com/python/python_ml_k-means.asp)
