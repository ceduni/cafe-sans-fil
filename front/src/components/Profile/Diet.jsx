...
const Diet = ({ index, handleDietsCheckboxChange, onDeleteDiet, name, description, checked, isStarter, forbiddenFoods, diets, setDiets }) => {
    const [numberValidCafes, setNumberValidCafes] = useState();
    const [showEditModal, setShowEditModal] = useState(false);
    const diet = { name, description, forbiddenFoods, valid_cafes: numberValidCafes, checked, isStarter };
            ...
            <div>
                ...
                <div className="text-left">
                    ...
                    <div className="py-2">
                        ...
                        <p className="text-md text-gray-700">{forbiddenFoods.join(", ")}</p>
                    </div>
                    <div>
                        <h3 className="text-md font-bold">Cafés: {numberValidCafes}</h3>
                    </div>
                </div>
            </div>
