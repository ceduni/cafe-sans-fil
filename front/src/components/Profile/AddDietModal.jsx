...
const AddDietModal = ({ isOpen, setIsOpen, diets, setDiets }) => {
    ...
    const [newDiet, setNewDiet] = useState(emptyDiet);
    ...
    const handleSubmit = (e) => {
        ...
        if (newDiet.name !== "" && forbiddenFoods.length !== 0 && forbiddenFoods.includes("") === false) {
            ...
            setDiets([...diets, newDiet2]);
            toggleModal();
            setNewDiet(emptyDiet)
  ...
  return (
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center w-full h-full overflow-x-hidden overflow-y-auto bg-gray-800 bg-opacity-50">
        <div className="relative h-fit w-full max-w-xl p-4 bg-white rounded-lg shadow dark:bg-white-700">
